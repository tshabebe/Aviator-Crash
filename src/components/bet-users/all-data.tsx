        ...
        <>
            <div>
                ...
                <div className="legend">
                    ...
                    <span className="bet">Bet, ETB</span>
                    <span>X</span>
                    <span className="cash-out">Cash out, ETB</span>
                </div>
            </div>
                    ...
                    {allData?.length > 0 ? (
                        allData.map((user, key) => (
                            <div className={`bet-item ${user.cashouted ? "celebrated" : ""}`} key={key}>
                                <div className="user">
                                    {user.img && <img className="avatar" src={user.img} alt="avatar" />}
                        ...
                        <div style={{ padding: '20px', textAlign: 'center', color: '#666' }}>
                            {pre ? 'No bets in previous round' : 'No bets yet'}
                        </div>
                    )}
                </div>
            </div>
